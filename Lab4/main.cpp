...
// 2.2 sumBlockingSquare: блочна€ верси€
template <typename T>
...
//-----------------------------------------------------------------
// 4) »спользуем dgemm из MKL дл€ умножени€ матриц
//-----------------------------------------------------------------
...
//-----------------------------------------------------------------
// 5) ”множение симметричной матрицы (BLAS3) cblas_dsymm
//-----------------------------------------------------------------
double measureMKL_dsymm(double* A, double* B, double* C, int N)
{
    // A Ч симметрична€, B Ч N x N
...
//-----------------------------------------------------------------
// 6) LAPACK dpotrf (разложение ’олецкого)
//-----------------------------------------------------------------
...
int main()
{
    ...
    // ==============================================================
    // 7.3. BLAS3: cblas_dsymm (симметрическа€ матрица)
    // ==============================================================
    {
        int N = 1024;
    ...
    // ==============================================================
    // 7.4. LAPACK: dpotrf (разложение ’олецкого)
    // ==============================================================
    {
        int N = 1024;
        std::cout << "\nExample dpotrf, N=" << N << "\n";
        ...
        // √енерируем A = M^T * M, чтобы A была симметричной положительно-определЄнной
        {
        ...
        // ѕосле dpotrf в A лежит верхн€€ часть R (если 'U'), так что
        // A Ц фактически R.
        // ѕроверку можно сделать (при малых N).
    }
